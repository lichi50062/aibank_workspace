 ...
 */
// @formatter:on
public class HomepageCardVo implements Serializable {
     ...
     * 牌卡說明
     */
    private List<HomepageCardI18nModel> cardDescs;
    ...
    public CardEvent getCardEvent() {
        return new CardEvent(this.taType, this.taGroup, this.cardTemplate, this.cardKey);
    }
    ...
    /**
     * @return the cardDescs
     */
    public List<HomepageCardI18nModel> getCardDescs() {
        return cardDescs;
    }

    /**
     * @param cardDescs
     *            the cardDescs to set
     */
    public void setCardDescs(List<HomepageCardI18nModel> cardDescs) {
        this.cardDescs = cardDescs;
    }

    @Override
    public String toString() {
        return "HomepageCardEntity{" + "cardId=" + cardId + '\'' + "cardName=" + cardName + '\'' + "cardSort=" + cardSort + '\'' + "cardBg=" + cardBg + '\'' + "cardIcon=" + cardIcon + '\'' + "cardFold=" + cardFold + '\'' + "showFlag=" + showFlag + '\'' + "query=" + query + '\'' + "createTime=" + createTime + '\'' + "updateTime=" + updateTime + '\'' + '}';
    }

 ...
 * @(#)TransRecord.java
 * 
 * <p>Description:『最近轉帳/常用/約定』帳號選擇元件(臺幣) - 轉帳紀錄</p>
 * 
 * <p>Modify History:</p>
 ...
 */
// @formatter:on
public class TwTransRecord implements Serializable {

    private static final long serialVersionUID = -8759208733656416502L;

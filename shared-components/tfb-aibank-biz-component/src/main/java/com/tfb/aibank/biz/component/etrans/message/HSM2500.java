...
public class HSM2500 {
    ...
    public String getRQ_TX_CODE() {
        return RQ_TX_CODE;
    }

    public void setRQ_TX_CODE(String rQ_TX_CODE) {
        RQ_TX_CODE = rQ_TX_CODE;
    }
    ...
    public String getRS_FESC_RESP_CODE() {
        return StringUtils.trimToEmptyEx(RS_FESC_RESP_CODE);
    }
    ...
    public Calendar getRS_TX_DATE_TIME_CalenderType() {
        Calendar cldr = Calendar.getInstance();
        String year = String.valueOf(cldr.get(Calendar.YEAR));
        Date d = DateUtils.getDateByDateFormat(year + RS_TX_DATE_TIME, "yyyyMMddHHmmss");
        cldr.setTime(d);
        return cldr;
    }
    ...
    public Date getRS_TX_DATE_TIME_DateType() {
        return getRS_TX_DATE_TIME_CalenderType().getTime();
    }

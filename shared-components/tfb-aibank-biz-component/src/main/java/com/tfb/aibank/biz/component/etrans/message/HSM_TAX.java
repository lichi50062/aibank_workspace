...
public class HSM_TAX {
    ...
    private String RQ_TAX_TYPE = "";
    private String RQ_TX_DATE_TIME2 = "";
    private String RQ_DUE_DATE = "";
    private String RQ_TAX_GOV_ID = "";
    ...
    public String getRQ_TAX_TYPE() {
        return RQ_TAX_TYPE;
    }

    public void setRQ_TAX_TYPE(String rQ_TAX_TYPE) {
        RQ_TAX_TYPE = rQ_TAX_TYPE;
    }
    ...
    public String getRQ_DUE_DATE() {
        return RQ_DUE_DATE;
    }

    public void setRQ_DUE_DATE(String rQ_DUE_DATE) {
        RQ_DUE_DATE = rQ_DUE_DATE;
    }

    public String getRQ_TAX_GOV_ID() {
        return RQ_TAX_GOV_ID;
    }

    public void setRQ_TAX_GOV_ID(String rQ_TAX_GOV_ID) {
        RQ_TAX_GOV_ID = rQ_TAX_GOV_ID;
    }

 ...
 * 
 * <p>Modify History:</p>
 * v1.0, 2024/10/09, Yoyo Lin	
 * <ol>
 *  <li>初版</li>
 * </ol>
 */
// @formatter:on
public class TwcaApiLoginRs extends TwcaApiRs {
    ...
    /** outputParams. */
    private TwcaApiLoginOutputParams outputParams;
     ...
     */
    public TwcaApiLoginOutputParams getOutputParams() {
        return outputParams;
    }
     ...
     *            {@link #outputParams}
     */
    public void setOutputParams(TwcaApiLoginOutputParams outputParams) {

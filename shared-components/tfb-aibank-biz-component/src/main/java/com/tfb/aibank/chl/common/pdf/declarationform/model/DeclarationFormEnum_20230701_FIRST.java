...
//@formatter:off
/**
* @(#)DeclarationFormEnum_20230701_FIRST.java
* 
* <p>Description:第一聯 (承辦銀行業或外匯證券商留存)</p>
* 
* <p>Modify History:</p>
...
*/
//@formatter:on
public enum DeclarationFormEnum_20230701_FIRST implements IDeclarationFormEnum {
  //@formatter:off
    CHECK_OPTION_1("checkbox", "國外匯入直接結售", 57.2f, 745.5f, 0.5f, 0f),
    CHECK_OPTION_2("checkbox", "國內他行匯入結售", 193.89f, 745.5f, 2.9f, 0f),
    CHECK_OPTION_3("checkbox", "由外匯存款提出結售", 343.88f, 745.5f, 0f, 0f),
    CHECK_OPTION_4("checkbox", "以外幣現鈔或旅行支票結售", 57.7f, 725.5f, 2f, 0f),
    CHECK_OPTION_5("checkbox", "其他(請說明)", 225.2f, 725.5f, 15f, 0f),
    CHECK_OPTION_5_CONTENT("text", "其他-說明內容", 341.18f, 720.5f),
    APPLY_DATE_YEAR("text", "申報日期(年)", 210.77f, 701.38f,0f,-3f),
    APPLY_DATE_MONTH("text", "申報日期(月)", 265.77f, 701.38f,0f,-3f),
    APPLY_DATE_DATE("text", "申報日期(日)", 317.77f, 701.38f,0f,-3f),
    DECLARANT_NAME("text", "申報義務人", 200.77f, 685.38f,0f,-3f),
    ...
    DECLARANT_RECEIPTS_OF_TRANSACTIONS_2("checkbox", "外匯收入或交易性質-其他匯入款項(勾選)", 80.7f,332.38f, 0f, -8f),
    DECLARANT_RECEIPTS_OF_TRANSACTIONS_2_CONTENT("text", "外匯收入或交易性質-其他匯入款項(內容)", 93.7f,311.38f, 0f, -8f),
    ...
    AMOUNT_REMITTED("text", "匯款金額", 192.77f,293.38f, 0f ,-5f),
    REMITTED_FROM_COUNTRY("text", "匯款地區國別", 241.77f,275.38f, 0f ,-5f),
    DECLARANT_SIGNATURE("text", "申報義務人(電子簽章)", 58.2f,178.38f),
    ADDRESS("text", "地址", 58.2f,131.88f),
    TELEPHONE("text", "電話", 300.2f,148.38f,0f,-5f),
    CASE_NO("text", "送件編號", 138.2f,85.38f,0f,2.5f),
    EXCHANGE_NO("text", "外匯水單編號", 226.2f,72.38f,0f,4f),
    BANKING_DSF_SEAL_AND_DATE("text", "銀行業或外匯證券商簽章及日期", 376.2f,75.38f,0f,2f),
  ...
  //@formatter:on
    ...
    private static final float GLOBAL_OFFSET_Y_FOR_SETTLEMENT_B = 2f;

    private static final String DOC_VER = "20230701";

    private static final DeclarationPageEnum DECLARATION_PAGE = DeclarationPageEnum.FIRST;
    ...
    private DeclarationFormEnum_20230701_FIRST(String type, String desc, float x, float y) {
        this.type = type;
        this.desc = desc;
        this.x = x;
        this.y = y;
     ...
     * @return
     */
    private DeclarationFormEnum_20230701_FIRST(String type, String desc, float x, float y, float offxForSettlmentB, float offyForSettlmentB) {
        this.type = type;
        this.desc = desc;
        this.x = x;
        this.y = y;

...
// @formatter:off
/**
 * @(#)EB5556986SvcRsTypeVo.java <p>Description:登入電文下行</p>
 *
 * <p>Modify History:</p>
 ...
 */
// @formatter:on
public class EB5556986Response {
    ...
    /**
     * @param nameCod the nameCod to set
     */
    ...
    /**
     * @param userIdLevel the userIdLevel to set
     */
    ...
    /**
     * @param ebillCheck the ebillCheck to set
     */
    ...
    /**
     * @param ebillEndDate the ebillEndDate to set
     */
    ...
    /**
     * @param promoCheck the promoCheck to set
     */
    ...
    /**
     * @param massChk the massChk to set
     */
    ...
    /**
     * @param namcodChk the namcodChk to set
     */
    ...
    /**
     * @param investCod the investCod to set
     */
    ...
    /**
     * @param iderrFlg the iderrFlg to set
     */
    ...
    /**
     * @param pwChgDate the pwChgDate to set
     */
    ...
    /**
     * @param useridChgDate the useridChgDate to set
     */
    ...
    /**
     * @param ebillStrDate the ebillStrDate to set
     */
    ...
    /**
     * @param otpMobile the otpMobile to set
     */
    ...
    /**
     * @param emailUnc the emailUnc to set
     */
    ...
    /**
     * @param addrUnc the addrUnc to set
     */

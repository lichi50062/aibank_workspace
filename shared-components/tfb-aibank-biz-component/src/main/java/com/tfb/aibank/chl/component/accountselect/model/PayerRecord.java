 ...
 * @(#)PayerRecord.java
 * 
 * <p>Description:『最近轉帳/常用/約定』帳號選擇元件 - 轉出</p>
 * 
 * <p>Modify History:</p>
 ...
 */
// @formatter:on
public class PayerRecord implements Serializable {
     ...
     *            the isTWD to set
     */
    public void setTWD(boolean isTWD) {
        this.isTWD = isTWD;
    }

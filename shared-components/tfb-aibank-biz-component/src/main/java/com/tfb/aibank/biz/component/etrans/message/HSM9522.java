...
public class HSM9522 {
    ...
    private String RQ_CAR_NO = "";
    private String RQ_SEX = "";
    private String RQ_LAST_NAME = "";
    private String RQ_LAST_NAME_DB = "";
    private String RQ_MOBILE_PHONE = "";
    private String RQ_PHONE = "";
    private String RQ_INSURANCE_NO = "";
    ...
    public String getRQ_CAR_NO() {
        return RQ_CAR_NO;
    }

    public void setRQ_CAR_NO(String rQ_CAR_NO) {
        RQ_CAR_NO = rQ_CAR_NO;
    }

    public String getRQ_SEX() {
        return RQ_SEX;
    }

    public void setRQ_SEX(String rQ_SEX) {
        RQ_SEX = rQ_SEX;
    }

    public String getRQ_LAST_NAME() {
        return RQ_LAST_NAME;
    }

    public void setRQ_LAST_NAME(String rQ_LAST_NAME) {
        RQ_LAST_NAME = rQ_LAST_NAME;
    }

    public String getRQ_LAST_NAME_DB() {
        return RQ_LAST_NAME_DB;
    }

    public void setRQ_LAST_NAME_DB(String rQ_LAST_NAME_DB) {
        RQ_LAST_NAME_DB = rQ_LAST_NAME_DB;
    }

    public String getRQ_MOBILE_PHONE() {
        return RQ_MOBILE_PHONE;
    }

    public void setRQ_MOBILE_PHONE(String rQ_MOBILE_PHONE) {
        RQ_MOBILE_PHONE = rQ_MOBILE_PHONE;
    }

    public String getRQ_PHONE() {
        return RQ_PHONE;
    }

    public void setRQ_PHONE(String rQ_PHONE) {
        RQ_PHONE = rQ_PHONE;
    }

    public String getRQ_INSURANCE_NO() {
        return RQ_INSURANCE_NO;
    }

    public void setRQ_INSURANCE_NO(String rQ_INSURANCE_NO) {
        RQ_INSURANCE_NO = rQ_INSURANCE_NO;
    }

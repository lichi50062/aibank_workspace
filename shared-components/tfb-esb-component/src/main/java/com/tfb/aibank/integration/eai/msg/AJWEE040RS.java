...
import tw.com.ibm.mf.eb.AJWEE040SvcRsType;
...
@Converter(
        ...
        datetimeConverters = {
                @DateAndTimeConverter(converter = EAIDateConverter.class, inputPattern = "0cccMMdd", fieldXPath = "eai:Tx/TxBody/TxRepeat/EndDate | eai:Tx/TxBody/TxRepeat/NetInterestDate | eai:Tx/TxBody/TxRepeat/RefValDate | eai:Tx/TxBody/TxRepeat/RefValDate2 | eai:Tx/TxBody/TxRepeat/StartDate | eai:Tx/TxBody/TxRepeat/TxcCancelDate | eai:Tx/TxBody/TxRepeat/TxDate")
        },
        decimalConverters = {
                @DecimalConverter(converter = EAIDecimalConverter.class, fieldXPath = "eai:Tx/TxBody/Occur | eai:Tx/TxBody/TxRepeat/ProdMinBuyAmt | eai:Tx/TxBody/TxRepeat/TrustVal1 | eai:Tx/TxBody/TxRepeat/TrustVal2 | eai:Tx/TxBody/TxRepeat/TrustVal3 | eai:Tx/TxBody/TxRepeat/TxTime | eai:Tx/TxBody/TxRepeat/TxVAl"),
                ...
                @DecimalConverter(converter = EAIDecimalConverter.class, scale = 9, fieldXPath = "eai:Tx/TxBody/TxRepeat/TxPrice")
        }
)
// @formatter:on
public class AJWEE040RS extends EAIResponse<AJWEE040SvcRqType, AJWEE040SvcRsType> {

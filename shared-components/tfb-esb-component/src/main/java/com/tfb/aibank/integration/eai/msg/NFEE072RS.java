...
import tw.com.ibm.mf.eb.NFEE072SvcRsType;
...
@Converter(
        ...
        decimalConverters = {
                        @DecimalConverter(converter = EAIDecimalConverter.class, fieldXPath = "eai:Tx/TxBody/Occur" +
                                ...
                                " | eai:Tx/TxBody/TxRepeat/TransferCount" + " | eai:Tx/TxBody/TxRepeat/TransferAmt"),
                        @DecimalConverter(converter = EAIDecimalConverter.class, scale = 2, fieldXPath = "eai:Tx/TxBody/TxRepeat/CurAmt | eai:Tx/TxBody/TxRepeat/CurBal" +
                                ...
                                " | eai:Tx/TxBody/TxRepeat/BefTransDivisCash " +
                                " | eai:Tx/TxBody/TxRepeat/BefCashReturn | eai:Tx/TxBody/TxRepeat/BefTransRefReturn " +
                                " | eai:Tx/TxBody/TxRepeat/AutoStoploss | eai:Tx/TxBody/TxRepeat/AutoSatisfied "),
                        ...
                        @DecimalConverter(converter = EAIDecimalConverter.class, scale = 4, fieldXPath = "eai:Tx/TxBody/TxRepeat/ExchangeRateNT | eai:Tx/TxBody/TxRepeat/UntNum" +
...
// @formatter:on
public class NFEE072RS extends EAIResponse<NFEE072SvcRqType, NFEE072SvcRsType> {

...
import tw.com.ibm.mf.eb.VN067NSvcRsType;

// @formatter:off
/**
 * @(#)VN067NRS.java
 * 
 * <p>Description:基金申購即時交易電文(VN067N) 下行電文</p>
 * 
 * <p>Modify History:</p>
...
@Converter(
        ...
        decimalConverters = {
                ...
                @DecimalConverter(converter = EAIDecimalConverter.class, scale=2, fieldXPath = "eai:Tx/TxBody/EstShortTerm_Fee | eai:Tx/TxBody/TransferFee" +
                        " | eai:Tx/TxBody/AcctBal  | eai:Tx/TxBody/AvailBal | eai:Tx/TxBody/Fee | eai:Tx/TxBody/Fee_M" +
                        " | eai:Tx/TxBody/Fee_H | eai:Tx/TxBody/EstimateMagtFee | eai:Tx/TxBody/BackFee"),
...
// @formatter:on
public class VN067NRS extends EAIResponse<VN067NSvcRqType, VN067NSvcRsType> {

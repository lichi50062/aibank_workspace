...
import tw.com.ibm.mf.eb.BPM001ASvcRsType;
 ...
 * @(#)BPM001ACCRS.java
 *
 * <p>Description:[資產總覽電文BPM001A(下行)]</p>
 *
 * <p>Modify History:</p>
...
@Converter(
                ...
                decimalConverters = {
                                ...
                                @DecimalConverter(converter = EAIDecimalConverter.class, fieldXPath = "eai:Tx/TxBody/CUR_CNT " +
                                                ...
                                                "| eai:Tx/TxBody/AcctIdspub1" +
                                                "| eai:Tx/TxBody/AcctIdspub2" ),
...
// @formatter:on
public class BPM001ACCRS extends BPMBaseCCRS<BPM001ASvcRqType, BPM001ASvcRsType> {
    ...
    protected boolean isNoData(String errId) {
        return super.isNoData(errId) || "V803".equals(errId) || "V829".equals(errId) || "X105".equals(errId);
    }
}

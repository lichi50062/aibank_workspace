 ...
 */
// @formatter:on
public class EAIPadRightConverter implements EAIConverter {

    @Override
    public String convertRq(Object... value) {
        return StringUtils.rightPadByByteLength((String) value[0], (Integer) value[1], (String) value[2]);
    }

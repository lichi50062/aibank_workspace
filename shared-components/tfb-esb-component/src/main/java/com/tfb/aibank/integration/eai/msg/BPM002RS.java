...
import tw.com.ibm.mf.eb.BPM002SvcRsType;
 ...
 * @(#)BPM002RS.java
 *
 * <p>Description:[資產總覽電文BPM002(下行)]</p>
 *
 * <p>Modify History:</p>
...
@Converter(
        customConverters = {
                @CustomConverter(converter = EAITrimConverter.class, fieldXPath = "eai:Tx/TxHead/* | eai:Tx/TxBody/IDNO " +
                                ...
                                "| eai:Tx/TxBody/TOTAL_AMT_64 | eai:Tx/TxBody/TOTAL_AMT_65 " +
                                "| eai:Tx/TxBody/TOTAL_AMT_67 | eai:Tx/TxBody/TOTAL_AMT_68 | eai:Tx/TxBody/TOTAL_AMT_69 | eai:Tx/TxBody/TOTAL_AMT_70 | eai:Tx/TxBody/TOTAL_AMT_73 | eai:Tx/TxBody/TOTAL_AMT_6302| eai:Tx/TxBody/TOTAL_AMT_6303" +
        ...
        datetimeConverters = {
                        ...
                        @DateAndTimeConverter(converter = EAIDateConverter.class, inputPattern = "HH:mm", fieldXPath = "eai:Tx/TxBody/TxRepeat/BRD_TIME")
        })
// @formatter:on
public class BPM002RS extends BPMBaseRS<BPM002SvcRqType, BPM002SvcRsType> {

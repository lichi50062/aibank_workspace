...
import tw.com.ibm.mf.eb.NJWEE010SvcRsType;
...
@Converter(
        ...
        decimalConverters = {
                @DecimalConverter(converter = EAIDecimalConverter.class, fieldXPath = "eai:Tx/TxBody/Occur | eai:Tx/TxBody/TxRepeat/UntVal | eai:Tx/TxBody/TxRepeat/UntNum"),
                ...
                @DecimalConverter(converter = EAIDecimalConverter.class,scale = 9, fieldXPath = "eai:Tx/TxBody/TxRepeat/RefValue | eai:Tx/TxBody/TxRepeat/ExchangeRate | eai:Tx/TxBody/TxRepeat/RefExRate")
        }
)
//@formatter:on
public class NJWEE010RS extends EAIResponse<NJWEE010SvcRqType, NJWEE010SvcRsType> {

...
@Converter(
                ...
                decimalConverters = {
                                ...
                                @DecimalConverter(converter = EAIDecimalConverter.class, fieldXPath = "eai:Tx/TxBody/CUR_CNT " +
                                                ...
                                                "| eai:Tx/TxBody/AcctIdCram " +
                                                "| eai:Tx/TxBody/AcctIdPcbl " +
                                                "| eai:Tx/TxBody/AcctIdDPayd " +
                                                "| eai:Tx/TxBody/AcctIdubS " +
                                                "| eai:Tx/TxBody/AcctIdPcblS "),
...
// @formatter:on
public class BPM001ARS extends BPMBaseRS<BPM001ASvcRqType, BPM001ASvcRsType> {

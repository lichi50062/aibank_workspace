package com.tfb.aibank.biz.systemconfig.services.roletask.model;

import io.swagger.v3.oas.annotations.media.Schema;

import java.util.Date;

@Schema(description = "交易設定")
public class TaskModel {

    /**
     * 此交易是否需要控管 0：不控管 1：控管 (預設)
     */
    @Schema(description = "此交易是否需要控管 0：不控管 1：控管 (預設)")
    private int accessControlFlag;

    /**
     * 交易群組代碼
     */
    @Schema(description = "交易群組代碼")
    private String appId;

    /**
     * 業務分類代碼
     */
    @Schema(description = "業務分類代碼")
    private String bizId;

    /**
     * 顯示方式
     */
    @Schema(description = "顯示方式")
    private int displayType;

    /**
     * 重覆submit 或 back 時要導到的頁面, 若為NULL則導回本交易首頁
     */
    @Schema(description = "重覆submit 或 back 時要導到的頁面, 若為NULL則導回本交易首頁")
     ...
     * 是否支援未登入之操作
     */
    @Schema(description = "是否支援未登入之操作")
    private int supportGuestOpFlag;

    /**
     * 交易暫停說明
     */
    @Schema(description = "交易暫停說明")
    private String suspendDesc;

    /**
     * 暫停結束時間
     */
    @Schema(description = "暫停結束時間")
    private Date suspendEndTime;

    /**
     * 暫停起始時間
     */
    @Schema(description = "暫停起始時間")
    private Date suspendStartTime;

    /**
     * 交易功能代號
     */
    @Schema(description = "交易功能代號")
    private String taskId;

    /**
     * 交易逾時設定 (0~9999)
     */
    @Schema(description = "交易逾時設定 (0~9999)")
     ...
     * </ul>
     */
    @Schema(description = "OTP使用類型")
    private int securityOtpTypes;

    /**
     * IOS最低支援版本
     */
    @Schema(description = "iosMinVersion")
    private String iosMinVersion;

    /**
     * ANDROID最低支援版本
     */
    @Schema(description = "androidMinVersion")
    private String androidMinVersion;

    /**
     * 可被記錄(0：不可1：可)
     */
    @Schema(description = "可被記錄(0：不可1：可)")

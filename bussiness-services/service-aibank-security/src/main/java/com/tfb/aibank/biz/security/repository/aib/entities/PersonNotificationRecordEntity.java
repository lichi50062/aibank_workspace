package com.tfb.aibank.biz.security.repository.aib.entities;
...
// @formatter:off
/**
 * @(#)PersonNotificationRecordEntity.java
 * 
 * <p>Description:個人化通知訊息 Entity</p>
 * 
 * <p>Modify History:</p>
...
public class PersonNotificationRecordEntity implements Serializable {
    ...
    /** 通知記錄鍵值 */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PERSON_NOTIFICATION_RECORD_SEQ")
    @SequenceGenerator(name = "PERSON_NOTIFICATION_RECORD_SEQ", sequenceName = "PERSON_NOTIFICATION_RECORD_SEQ", allocationSize = 1)

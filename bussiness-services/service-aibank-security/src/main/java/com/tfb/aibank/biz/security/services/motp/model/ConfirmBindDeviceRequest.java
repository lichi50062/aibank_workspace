 ...
 */
// @formatter:on
@Schema(description = "確認建立MOTP設備綁定 - Request")
public class ConfirmBindDeviceRequest {
    ...
    @Schema(description = "SDK addProfile response deviceID")
    private String deviceId;

    /** SDK addProfile response ClientID */
    @Schema(description = "SDK addProfile response ClientID")
    private String clientId;

    /** SDK addProfile response SN */
    @Schema(description = "SDK addProfile response SN")
    private String sn;

    /** SDK addProfile response pushID */
    @Schema(description = "SDK addProfile response pushID")
    private String pushId;

    /** 裝置代碼 */
    @Schema(description = "裝置代碼")
    ...
    /** MOTP MID認證資料鍵值 */
    @Schema(description = "motpMidDataKeyList")
    private List<Integer> motpMidDataKeyList;

    /** MOTP綁定時約定條款版本 */
    @Schema(description = "MOTP綁定時約定條款版本")

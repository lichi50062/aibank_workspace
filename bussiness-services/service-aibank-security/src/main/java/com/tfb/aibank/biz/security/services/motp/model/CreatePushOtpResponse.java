 ...
 */
// @formatter:on
@Schema(description = "發送推播OTP - Response")
public class CreatePushOtpResponse {

    /** 裝置暱稱 */
    @Schema(description = "裝置暱稱")
    ...
    /** 與MOTP綁定為相同裝置 */
    @Schema(description = "與MOTP綁定為相同裝置")
    private boolean sameDevice;

    /** 手機端用戶ID 對應全景addProfile後取得之ClientID */
    @Schema(description = "手機端用戶ID 對應全景addProfile後取得之ClientID")
    private String clientId;

    /** 挑戰碼 */
    @Schema(description = "挑戰碼")
    private String challenge;

    /** 有效時間(秒) */
    @Schema(description = "有效時間(秒)")
    private int expireTime;

    /** 交易認證資訊鍵值 */
    @Schema(description = "交易認證資訊鍵值")
    private Integer motpTransDataKey;

    /** 交易驗證載具資訊鍵值 */
    @Schema(description = "交易驗證載具資訊鍵值")

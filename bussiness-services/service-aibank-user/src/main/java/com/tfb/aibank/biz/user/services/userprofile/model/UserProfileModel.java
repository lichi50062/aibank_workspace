...
public class UserProfileModel implements Serializable {
    ...
    private static final long serialVersionUID = -8971386197276912549L;
    ...
    /** 頭像設定 */
    @Schema(description = "頭像設定")
    private String avatar;

    /** 使用者中文姓名 */
    @Schema(description = "使用者中文姓名")
    private String userCname;

    /** 使用者英文姓名 */
    @Schema(description = "使用者英文姓名")
    ...
    /** 聯絡電話（分機） */
    @Schema(description = "聯絡電話（分機）")
    private String tel3;

    /** 傳真（區碼） */
    @Schema(description = "傳真（區碼）")
    private String fax1;
    ...
    /** 台幣單筆編輯限額 */
    @Schema(description = "台幣單筆編輯限額")
    private BigDecimal twEditQuota;

    /** 台幣單筆審核限額 */
    @Schema(description = "台幣單筆審核限額")
    private BigDecimal twVerifyQuota;

    /** 台幣單筆放行限額 */
    @Schema(description = "台幣單筆放行限額")
    private BigDecimal twPassQuota;

    /** 台幣單日累計放行限額 */
    @Schema(description = "台幣單日累計放行限額")
    private BigDecimal twDailyPassQuota;

    /** 外幣單筆編輯限額 */
    @Schema(description = "外幣單筆編輯限額")
    private BigDecimal fxEditQuota;

    /** 外幣單筆審核限額 */
    @Schema(description = "外幣單筆審核限額")
    private BigDecimal fxVerifyQuota;

    /** 外幣單筆放行限額 */
    @Schema(description = "外幣單筆放行限額")
    private BigDecimal fxPassQuota;

    /** 外幣單日累計放行限額 */
    @Schema(description = "外幣單日累計放行限額")
    private BigDecimal fxDailyPassQuota;

    /** 台幣放行累計日期 */
    @Schema(description = "台幣放行累計日期")
    private Date twPassDate;

    /** 台幣當日放行總金額 */
    @Schema(description = "台幣當日放行總金額")
    private BigDecimal twTotalPassAmt;

    /** 外幣放行累計日期 */
    @Schema(description = "外幣放行累計日期")
    private Date fxPassDate;

    /** 外幣當日放行總金額 */
    @Schema(description = "外幣當日放行總金額")
    private BigDecimal fxTotalPassAmt;

    /** 是否隱藏外幣帳戶0:否 1:是 */
    @Schema(description = "是否隱藏外幣帳戶0:否 1:是")
    private String hiddenFxAccount;

    /** 信用卡網路會員修改密碼時間 */
    @Schema(description = "信用卡網路會員修改密碼時間")
    private Date txDate;

    /** 是否隱藏貸款餘額為零帳戶0:否 1:是) */
    @Schema(description = "是否隱藏貸款餘額為零帳戶0:否 1:是)")

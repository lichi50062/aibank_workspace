 ...
 */
@Entity
@Table(name = "IP_LOCATION_B", schema = "DBUSERNEB")
@IdClass(IpLocationEntityPk.class)
public class IpLocationBEntity implements Serializable {
    ...
    public IpLocationBEntity() {
    }
    
    public IpLocationBEntity(Long ipFrom, Long ipTo) {
        this.ipFrom = ipFrom;
        this.ipTo = ipTo;
    }
    ...
    public boolean equals(Object o) {
        ...
        IpLocationBEntity that = (IpLocationBEntity) o;

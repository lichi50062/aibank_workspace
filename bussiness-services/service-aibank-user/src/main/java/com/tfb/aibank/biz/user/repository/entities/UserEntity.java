...
public class UserEntity implements Serializable {
    ...
    /**
     * 密碼驗證方式 0：此使用者以舊密碼格式檢核密碼 1：資轉後的值 或 異動密碼後的值 或 登入後更新 Y：新密碼格式已通過驗證 N：新密碼格式驗證失敗
     */
    public static String PWD_FLG_INIT = "0";
    public static String PWD_FLG_USER_CHANGED = "1";
    public static String PWD_FLG_NEW_PASS = "Y";
    public static String PWD_FLG_NEW_INVALID = "N";
     ...
     * 新增密碼狀態欄位[0:初始狀態 /
     * 
     * 1:已更改密碼（PASSWORD_ADVANCED有值）/
     * 
     * Y:PASSWORD_ADVANCED已驗證成功 /
     * 
     * N:PASSWORD_ADVANCED驗證失敗]
     */
    @Basic
    @Column(name = "PWD_FLAG")
    private String pwdFlag;

    /** SHA512使用者密碼 */
    @Basic
    @Column(name = "PASSWORD_ADVANCED")
    private String passwordAdvanced;
    ...
    /**
     * @return the passwordAdvanced
     */
    public String getPasswordAdvanced() {
        return passwordAdvanced;
    }

    /**
     * @param passwordAdvanced
     *            the passwordAdvanced to set
     */
    public void setPasswordAdvanced(String passwordAdvanced) {
        this.passwordAdvanced = passwordAdvanced;
    }

    /**
     * 已開啟新密碼, 第1次在舊密碼驗成功，且新密碼欄位是空，才需更新
     * 
     * @return
     */
    public boolean isNeedUpdatePasswordAdvanced() {
        return (StringUtils.isBlank(this.pwdFlag) || StringUtils.equals(this.pwdFlag, PWD_FLG_INIT) && StringUtils.isBlank(this.passwordAdvanced));
    }

    /**
     * 當前一次登入已開啟新密碼，且有寫入新密碼後，可以使用新密碼進行驗證
     * 
     * @return
     */
    public boolean isNeedCheckPasswordAdvanced() {
        return StringUtils.equals(this.pwdFlag, UserEntity.PWD_FLG_USER_CHANGED);
    }

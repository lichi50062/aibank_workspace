...
*/
@Entity
@Table(name = "CHANGE_PASSWORD_RECORD")
public class ChangePasswordRecordEntity implements Serializable {
     ...
     */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CHANGE_PASSWORD_RECORD_SEQ")
    @SequenceGenerator(name = "CHANGE_PASSWORD_RECORD_SEQ", sequenceName = "CHANGE_PASSWORD_RECORD_SEQ", allocationSize = 1)

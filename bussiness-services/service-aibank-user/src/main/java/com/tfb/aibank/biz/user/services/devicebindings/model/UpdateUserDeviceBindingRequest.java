...
public class UpdateUserDeviceBindingRequest {
    ...
    /** 是否更新免登速查註記 */
    @Schema(description = "是否更新免登速查註記")
    private boolean isUpdateQsearchFlag;

    /** 免登速查註記 */
    @Schema(description = "免登速查註記")
    ...
    /** 簡易登入授權日期 */
    @Schema(description = "簡易登入授權日期")
    private Date loginAuthDate;

    /** 是否更新雙重驗證登入註記 */
    @Schema(description = "是否更新雙重驗證登入註記")
    private boolean isUpdateTwoStepFlag;

    /** 是否授權雙重驗證登入 */
    @Schema(description = "是否授權雙重驗證登入")
    private int twostepFlag;

    /** 是否更新訊息通知註記 */
    @Schema(description = "是否更新訊息通知註記")
    ...
    /** 訊息通知授權日期 */
    @Schema(description = "訊息通知授權日期")
    private Date notifyAuthDate;

    /**
     * 訊息設定 0:未開啟訊息通知(全天不可發送) 1:已開啟訊息通知(全天可發送) 2:夜間勿擾(2100~0900不發送)
     */
    @Schema(description = "訊息設定 0:未開啟訊息通知(全天不可發送) 1:已開啟訊息通知(全天可發送) 2:夜間勿擾(2100~0900不發送)")
    private int notifyPass;

    /** 是否更新錢包註記 */
    @Schema(description = "是否更新錢包註記")
    private boolean isUpdateWalletFlag;

    /** 錢包註記 */
    @Schema(description = "錢包註記")
    ...
    /**
     * @return {@link #isUpdateTwoStepFlag}
     */
    public boolean isUpdateTwoStepFlag() {
        return isUpdateTwoStepFlag;
    }

    /**
     * @param isUpdateTwoStepFlag
     *            {@link #isUpdateTwoStepFlag}
     */
    public void setUpdateTwoStepFlag(boolean isUpdateTwoStepFlag) {
        this.isUpdateTwoStepFlag = isUpdateTwoStepFlag;
    }

    /**
     * @return {@link #twostepFlag}
     */
    public int getTwostepFlag() {
        return twostepFlag;
    }
     ...
     *            {@link #twostepFlag}
     */
    public void setTwostepFlag(int twostepFlag) {
     ...
     */
    public void setNotifyPass(int notifyPass) {

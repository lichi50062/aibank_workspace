...
//@formatter:off
/**
* @(#)UpdateSecurDataSyncStatusApiRequest.java
* 
* <p>Description: 富邦證券彙整狀態上行request</p>
* 
* <p>Modify History:</p>
...
*/
//@formatter:on
@Schema(description = "富邦證券彙整狀態上行")
public class UpdateSecurDataSyncStatusApiRequest {

 ...
 * @(#)EB12020007Res.java
 * 
 * <p>Description:查詢/變更客戶通訊資料 下行</p>
 * 
 * <p>Modify History:</p>
 ...
 */
// @formatter:on
@Schema(description = "查詢/變更客戶通訊資料 下行")
public class EB12020007Res extends TxHeadRs {

    private static final long serialVersionUID = -8236731510963214459L;

    @Schema(description = "回傳代碼")
    private String msgCod;

    @Schema(description = "訊息中文代碼")
    ...
    @Schema(description = "通訊電話")
    private String phone;

    @Schema(description = "通訊電話分機")
    private String phoneExt;

    @Schema(description = "資料")
    private List<EB12020007Rep> repeats;
    ...
    public List<EB12020007Rep> getRepeats() {
        return repeats;
    }

    public void setRepeats(List<EB12020007Rep> repeats) {

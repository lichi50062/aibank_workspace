...
@Schema(description = "客戶分群跨行手續費優惠查詢(FEP512166)下行電文")
public class FEP512166Response implements Serializable {

    private static final long serialVersionUID = -8446751133840675917L;

    /** 提款優惠次數 */
    @Schema(description = "提款優惠次數")
    private Integer specCsCnt;

    /** 提款優惠剩餘 */
    @Schema(description = "提款優惠剩餘")
    private Integer remainCsCnt;

    /** 轉帳優惠次數 */
    @Schema(description = "轉帳優惠次數")
    private Integer specTrCnt;

    /** 轉帳優惠剩餘 */
    @Schema(description = "轉帳優惠剩餘")
    private Integer remainTrCnt;

    /** 使用他行設備轉帳減免次數 */
    @Schema(description = "使用他行設備轉帳減免次數")
    private Integer specTrCnt2;

    /** 使用他行設備轉帳剩餘次數 */
    @Schema(description = "使用他行設備轉帳剩餘次數")
    private Integer remainTrCnt2;

    /** 客戶分群等級 */
    @Schema(description = "客戶分群等級")
    private String vipFlag;

    /** 客戶分群等級中文 */
    @Schema(description = "客戶分群等級中文")
    private String vipFlagName;

    /** 其他優惠身份註記1 */
    @Schema(description = "其他優惠身份註記1")
    private String srcFlg1;

    /** 其他優惠身份註記2 */
    @Schema(description = "其他優惠身份註記2")
    private String srcFlg2;

    /** 其他優惠身份註記3 */
    @Schema(description = "其他優惠身份註記3")
    private String srcFlg3;

    /** 其他優惠身份註記4 */
    @Schema(description = "其他優惠身份註記4")
    private String srcFlg4;

    /** 其他優惠身份註記5 */
    @Schema(description = "其他優惠身份註記5")
    private String srcFlg5;

    /** 其他優惠身份註記6 */
    @Schema(description = "其他優惠身份註記6")

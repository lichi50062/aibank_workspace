...
//@formatter:on
@Component
public class NSTOT005040Rs implements RsData {

    /** 轉入帳號 */
    private List<TwPayeeRecord> payees;

    /**
     * @return the payees
     */
    public List<TwPayeeRecord> getPayees() {
        return payees;
    }
     ...
     *         the payees to set
     */
    public void setPayees(List<TwPayeeRecord> payees) {
        this.payees = payees;
    }

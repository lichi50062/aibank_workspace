...
//@formatter:on
@Component
public class NSTOT005030Rs implements RsData {

    /** 轉入帳號 */
    private List<PayeeRecord> payees;

    /**
     * @return the payees
     */
    public List<PayeeRecord> getPayees() {
        return payees;
    }
     ...
     *            the payees to set
     */
    public void setPayees(List<PayeeRecord> payees) {
        this.payees = payees;
    }

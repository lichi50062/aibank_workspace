...
import com.tfb.aibank.chl.creditcard.ag009.model.NCCAG009020Rq;
import com.tfb.aibank.chl.creditcard.ag009.model.NCCAG009020Rs;
import com.tfb.aibank.chl.creditcard.ag009.service.NCCAG009Service;
import com.tfb.aibank.chl.model.creditcard.CreditCard;

//@formatter:off
/**
 * @(#)NCCAG009020Task.java
 * 
 * <p>Description:信用卡掛失 結果頁</p>
 * 
 * <p>Modify History:</p>
...
@Component
@Scope("prototype")
public class NCCAG009020Task extends AbstractAIBankBaseTask<NCCAG009020Rq, NCCAG009020Rs> {

    @Override
    public void validate(NCCAG009020Rq rqData) throws ActionException {
        // nothing...
    }

    @Override
    public void handle(NCCAG009020Rq rqData, NCCAG009020Rs rsData) throws ActionException {

...
// @formatter:on
@Component
public class NCCQU008060Rs extends RsDataExtension {
    ...
    /** 分期總額 */
    private String installmentSumAmt;
    ...
    /**
     * @return the installmentSumAmt
     */
    public String getInstallmentSumAmt() {
        return installmentSumAmt;
    }

    /**
     * @param installmentSumAmt
     *            the installmentSumAmt to set
     */
    public void setInstallmentSumAmt(String installmentSumAmt) {
        this.installmentSumAmt = installmentSumAmt;
    }

...
//@formatter:on
@Component
public class NGNOT005020Rs implements RsData {
    ...
    /** 忘記帳密 URL 信用卡會員 **/
    private String forgetCreditUrl;
    ...
    /**
     * @return the forgetCreditUrl
     */
    public String getForgetCreditUrl() {
        return forgetCreditUrl;
    }

    /**
     * @param forgetCreditUrl
     *            the forgetCreditUrl to set
     */
    public void setForgetCreditUrl(String forgetCreditUrl) {
        this.forgetCreditUrl = forgetCreditUrl;
    }

...
import com.tfb.aibank.chl.general.ot001.model.NGNOT001013Rq;
import com.tfb.aibank.chl.general.ot001.model.NGNOT001013Rs;
...
@Component
@Scope("prototype")
public class NGNOT001013Task extends AbstractAIBankBaseTask<NGNOT001013Rq, NGNOT001013Rs> {

    @Autowired
    UserResource userResource;

    @Override
    public void validate(NGNOT001013Rq rqData) throws ActionException {

    }

    @Override
    public void handle(NGNOT001013Rq rqData, NGNOT001013Rs rsData) throws ActionException {
        logger.debug("==== NGNOT001013 start====");
